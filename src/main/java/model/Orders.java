...
public class Orders {
	...
	private List<ProductOrders> listP;
	...
	public Orders(int orderId, float price, int status, Date orderDate, String address, String phoneNumber,
			List<ProductOrders> listP, String userMail, Date receivedDate) {
	...
	public List<ProductOrders> getListP() {
		return listP;
	}
	

	public void setListP(List<ProductOrders> listP) {
		this.listP = listP;
	}
